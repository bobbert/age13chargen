class CharacterClassesController < ApplicationController
  ...
  private
    ...
    def character_class_params
      params.require(:character_class).permit(:name, :baseHp, :recoveryDie, :basePd, :baseMd, :defaultAc, :numTalents, :numBackgrounds, :default1hWeaponDie, :default2hWeaponDie, :defaultThrownDie, :defaultBowDie, :shieldPenalty, :meleeMissDmg, :rangedMissDmg)
    end
end
